...
<div class="wrapper">
	<div class="ex-page-content text-center">
		...
		<h2>We&rsquo;ll be back soon!</h2><br>
		<p class="text-muted">Sorry for the inconvenience but we&rsquo;re performing some maintenance at the moment. </p>
		<p class="text-muted">If you need to you can always <a href="mailto:support@unbeleadsable.com">contact us</a>, otherwise we&rsquo;ll be back online shortly!</p>
		<p><img src="../assets/img/logo.png" class="img-responsive center-block"></p>
	</div>
</div>
