	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 col-md-offset-2">
				<div class="card-box">
					<h2 class="page-title m-b-20">Any Payment</h2>
					<form id="subscription" class="form-horizontal" role="form" data-parsley-validate="" novalidate >
						...
						<input type="hidden" name="case" value="<?php echo Tokenizer::add('post-case-any_payment', 30, 'any_payment'); ?>">
						...
						<div class="well">
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input class="form-control" step="0.01" name="amount" id="amount" type="number" />
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">Prefered Language:</label>
							<div class="col-sm-7">
								<select class="form-control fancy" name="lang" id="country" >
