				...
				<div class="card-box table-responsive">
					<div class="row">
						<div class="col-md-12 m-b-20">
							...
							<a class="btn btn-success waves-effect waves-light pull-right m-r-5" href="subscriptions"><i class="fa fa-usd"></i> &nbsp;Manuel Subscription</a>
					...
					<div class="row">
						<div class="col-md-12 m-b-20">
							<div id="invoices-wrapper"><?php require_once('load/invoices.php'); ?></div>
						</div>
					</div>
				</div>
			</div>
		...
		<script>
			$(function(){
				...
				$('#searchInvoice').submit(function(e){
					e.preventDefault();
					$('#invoices-wrapper').load("load/invoices.php?search&"+$(this).serialize());
					return false;
				});
			});
		</script>
